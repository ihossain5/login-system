        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="p-3">
                    ...
                    <p class="text-muted text-center">Enter your name to reset password</p>
                    ...
                    <form class="form-horizontal m-t-30 loginForm" method="POST" action="{{route('forgot.password.notify')}}">@csrf
