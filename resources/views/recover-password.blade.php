        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="p-3">
                    ...
                    <form class="form-horizontal m-t-30 loginForm" method="POST" action="{{ route('password.reset') }}">
                        @csrf

                        <div class="form-group">
                            <label for="username">User Name</label>
                            <input type="text" name="user_name" class="form-control" id="username" readonly
                                placeholder="Enter username" value="{{ $user->user_name }}">
                        </div>
                        <div class="form-group">
        ...
        $(document).ready(function() {
            $(".loginForm").validate({
                ...
                messages: {
                    ...
                    password_confirmation: {
                        required: 'Plese enter confirm your password',
                    },
                }
            });
        });
